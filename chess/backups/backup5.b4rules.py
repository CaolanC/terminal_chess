...
def corPiece(move):
    if 'O' in move:
        ...
        a = move.split('x')[0]
    if not isPawn(a) and white() and board[a[1:]] == a + '+':
        return True

    if isPawn(a) and white() and board[a] == a + '+':
        return True

    elif not isPawn(a) and not white() and board[a[1:]] == a + '-':
        return True

    elif isPawn(a) and not white() and board[a] == a + '-':
        return True
